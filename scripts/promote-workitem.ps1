...
try {
    ...
    if ([string]$assessment.policy_version -in @('5.10','5.11','5.12','5.13','5.14','5.15','6.0','6.1','6.2') -and $lastLedgerStatus -in $technicalPriorSkips -and -not [bool]$generatedJob.allow_after_prior_skip) {
