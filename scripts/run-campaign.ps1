...
The user explicitly requested this persistent campaign. If goal_status and goal_set are available, inspect goal state once and create the bounded coordinator goal described by the skill when none is active. Goal continuation does not authorize duplicate external side effects, and workers never create goals.
